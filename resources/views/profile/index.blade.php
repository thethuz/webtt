                    ...
                    <form enctype="multipart/form-data" action="/user/upload_avatar" method="POST">
                        ...
                        <div>
                            <img src="/uploads/avatars/{{ $user->avatar }}"
                                 style="width:150px; height:150px; float:left; border-radius:50%; margin-right:25px;margin-bottom: 12px"/>
                        </div>
                ...
                <div class="col-lg-8">
                    <form method="POST" action="/user/update_profile">
                        ...
                        <div class="form-group">
                            ...
                            <input id="location" placeholder="Enter a location" type="text" class="form-control"
                                   name="location" value="{{ $user->location }}">
                        </div>

                        <div class="form-group">
                            <label for="title">Title</label>
                            <input type="title" placeholder="No title has been set" type="text" class="form-control"
