...
class QuestionsController extends Controller
{
    ...
    {
        if (Auth::user()) {
            $tags = include 'careers.txt';
            return view('question.ask', ['tags' => $tags]);
        } else {
    ...
    public function showEditQuestion($id)
    {
        ...
        $alltags = include 'careers.txt';
        return view('question.edit_question', ['question' => $question, 'alltags' => $alltags]);
    }
